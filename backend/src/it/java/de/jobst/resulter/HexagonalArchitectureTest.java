...
public class HexagonalArchitectureTest {
    ...
    public void domainMustNotDependOnAnythingOutsideOfDomain() {
        noClasses()
                ...
                .orShould().dependOnClassesThat().resideInAPackage("de.jobst.resulter")
    ...
    public void applicationMustNotDependOnAdapters() {
        noClasses()
                ...
                .should().dependOnClassesThat().resideInAPackage("..adapter..").allowEmptyShould(true)
                .check(productionAndTestClasses());
    }
    ...
    private JavaClasses productionAndTestClasses() {
        return new ClassFileImporter().importPackages("de.jobst.resulter");
    }
