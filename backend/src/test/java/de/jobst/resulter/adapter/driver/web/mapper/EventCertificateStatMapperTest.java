...
class EventCertificateStatMapperTest {
    ...
    void toDtos_shouldMapCorrectly() {
        ...
        Instant generated = Instant.parse("2024-06-01T10:00:00Z");

        EventCertificateStat stat = EventCertificateStat.of(1L, eventId, personId, generated);
        ...
        List<EventCertificateStatDto> dtos = EventCertificateStatMapper.toDtos(List.of(stat), eventMap, personMap);

        assertThat(dtos).hasSize(1);
        EventCertificateStatDto dto = dtos.getFirst();
        assertThat(dto.id()).isEqualTo(1L);
        assertThat(dto.event().id()).isEqualTo(eventId.value());
        assertThat(dto.person().id()).isEqualTo(personId.value());
        assertThat(dto.generated()).isEqualTo(generated);
    }
