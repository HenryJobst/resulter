...
import AdminSidebar from '@/features/common/components/AdminSidebar.vue'
import MessageDetailDialog from '@/features/common/components/MessageDetailDialog.vue'
import TopNavbar from '@/features/common/components/TopNavbar.vue'
...
<template>
    <div class="app-layout">
        ...
        <!-- Footer -->
        <footer class="flex justify-between items-center px-6 py-4 border-t border-adaptive bg-adaptive-secondary">
            <div class="flex items-center gap-4">
                ...
                <div v-if="authStore.authenticated" class="text-sm text-adaptive-secondary">
