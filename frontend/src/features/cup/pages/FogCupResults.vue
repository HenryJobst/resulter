        ...
        <div id="club_results">
            ...
            <section v-if="overallScores.length" class="">
                <table>
                    ...
                    <tbody>
                        <tr
                            v-for="(org, index) in overallScores"
                            :key="org.organisation.id"
                            class=""
                        >
                            <td class="pl">
                                <img v-if="index === 0" src="@/assets/1.jpg" alt="Platz 1.">
                                <img v-else-if="index === 1" src="@/assets/2.jpg" alt="Platz 2.">
                                <img v-else-if="index === 2" src="@/assets/3.jpg" alt="Platz 3.">
            ...
            <section v-if="overallScores.length">
                ...
                <table v-for="org in overallScores" :key="org.organisation.id" class="my-3">
                    <tbody>
                        <tr>
