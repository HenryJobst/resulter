...
public record OrganisationScoreDto(
    ...
    public static OrganisationScoreDto from(OrganisationScore organisationScore, CountryService countryService) {
        return new OrganisationScoreDto(
                OrganisationDto.from(organisationScore.organisation(), countryService),
