...
/**
 * 
 *         Element that connects a course with an individual competitor. Courses should be present in the RaceCourseData element and are matched on course value and/or course family. Persons are matched by 1) BibNumber, 2) EntryId.
 *       
 * 
 ...
 * 
 * <pre>
 * &lt;complexType value="PersonCourseAssignment"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element value="PersonName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
