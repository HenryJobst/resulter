 ...
 *       
 * 
 * <p>Java-Klasse für PersonResult complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType value="PersonResult"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element value="Result" type="{http://www.orienteering.org/datastandard/3.0}PersonRaceResult" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    implements Serializable
{
    ...
    protected List<PersonRaceResult> results;
     ...
     * 
     */
    public List<PersonRaceResult> getResults() {
        if (results == null) {
            results = new ArrayList<PersonRaceResult>();
        }
        return this.results;
    }
