 ...
 *       
 * 
 * <p>Java-Klasse für PersonStart complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType value="PersonStart"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element value="Start" type="{http://www.orienteering.org/datastandard/3.0}PersonRaceStart" maxOccurs="unbounded"/&gt;
    ...
    implements Serializable
{
    ...
    protected List<PersonRaceStart> starts;
     ...
     * 
     */
    public List<PersonRaceStart> getStarts() {
        if (starts == null) {
            starts = new ArrayList<PersonRaceStart>();
        }
        return this.starts;
    }
