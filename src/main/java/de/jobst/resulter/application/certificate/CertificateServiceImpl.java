...
public class CertificateServiceImpl implements CertificateService {
    ...
    public CertificateServiceImpl(String mediaFilePath) {
    ...
    private static void setLocalFont(TextBlock textBlock, Text text) {
        ...
        if (textBlock.text().font() != null) {
            PdfFont textFont = CertificateServiceImpl.getPdfFont(textBlock.text().font());
            if (textFont != null) {
    ...
    @Override
    public Certificate createCertificate(Event event,
        ...
        PersonRaceResult prr = PersonRaceResult.of(
                ...
                (byte) 1,
                ResultStatus.OK);
        return createCertificate(p, organisation, event, eventCertificate, prr, mediaFileService);
    }
