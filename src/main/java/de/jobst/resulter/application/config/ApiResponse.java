...
public class ApiResponse<T> {
    ...
    private String message; // message to describe the result
    private T data; // actual response data of type T (can be an entity, a list, or any other object)
    private List<String> errors; // list of String errors that describe what went wrong if the request failed
